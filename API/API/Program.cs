...
//builder.Services.AddScoped<IAuth_Manager_Service, Auth_Manager_Service>();
//builder.Services.AddScoped<IPassword_Reset_Repo, Password_Reset_Repo>();
//builder.Services.AddScoped<IPassword_Reset_Service, Password_Reset_Service>();
...
//builder.Services.AddScoped<IJob_Experience_Repo, Job_Experience_Repo>();
//builder.Services.AddScoped<IProfessional_License_Repo, Professional_License_Repo>();
//builder.Services.AddScoped<IPersonal_Repo, Personal_Repo>();
//builder.Services.AddScoped<IGeneralTask_Repo, GeneralTask_Repo>();
//builder.Services.AddScoped<ICase_Comments_Service, Case_Comments_Service>();
//builder.Services.AddScoped<ICase_Managment_Service, Case_Managment_Service>();
...
//builder.Services.AddScoped<IProfessional_License_Service, Professional_License_Service>();
//builder.Services.AddScoped<IDependent_Repo, Dependent_Repo>();
//builder.Services.AddScoped<IDependent_Service, Dependent_Service>();
//builder.Services.AddScoped<IZoom_Service, Zoom_Service>();
//builder.Services.AddScoped<IZoom_Meeting_Repo, Zoom_Meeting_Repo>();
//builder.Services.AddScoped<IZoom_Meeting_Service, Zoom_Meeting_Service>();
//builder.Services.AddScoped<IWeb_Page_Repo, Web_Page_Repo>();
//builder.Services.AddScoped<IWeb_Page_Service, Web_Page_Service>();
//builder.Services.AddScoped<IContact_Page_Repo, Contact_Page_Repo>();
//builder.Services.AddScoped<IContact_Page_Service, Contact_Page_Service>();
...
//builder.Services.AddScoped<ILog_Service , Log_Service>();
...
//builder.Services.AddScoped<IPayment_With_Strip_Service, Payment_With_Strip_Service>();
...
//builder.Services.AddScoped<ITenant_Api_Hits_Service, Tenant_Api_Hits_Service>();
...
//builder.Services.AddScoped<ITenant_License_Keys_Repo, Tenant_License_Keys_Repo>();
...
//builder.Services.AddScoped<IWallet_Pass_Repo, Wallet_Pass_Repo>();
