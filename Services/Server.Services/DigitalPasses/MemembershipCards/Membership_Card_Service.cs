...
namespace Server.Services
{
    public class Membership_Card_Service : Base_Service<MembershipCard>, IMembership_Card_Service
    {
        ...
        private readonly IMembership_Card_Repo    _iRepo;
        ...
        /// <returns></returns>
        public async Task<ResponseModel<string>> GenerateCard(Apple_Passes_Membership_Card_Model model)
        {
            try
            {
                ...
                //Getting Pass
                MembershipCard Membership       = new();
                Membership.Type                 = Pass_Type_GModel.MembershipCard; 
                ...
                Membership.Member_Name          = model.Member_Name;
                ...
                Membership.Membership_Number    = string.IsNullOrEmpty(model.Membership_Number)?serialNo.ToString(): model.Membership_Number;
                ...
                Membership.Additional_Benefits  = model.Additional_Benefits;
        ...
        public async Task<ResponseModel<string>> UpdateGiftCard(Apple_Passes_Membership_Card_Model GiftCard)
        {
           try
            {
                ResponseModel<string> giftResponse = new()
                ...
                MembershipCard Membership       = await _iRepo.FindOne(x=>x.Id==GiftCard.Id);
                ...
                Membership.Membership_Number    = !string.IsNullOrEmpty(GiftCard.Membership_Number)? GiftCard.Membership_Number:Membership.Membership_Number;
                Membership.Member_Name          = !string.IsNullOrEmpty(GiftCard.Member_Name) ? GiftCard.Member_Name : Membership.Member_Name;
                Membership.Additional_Benefits  = !string.IsNullOrEmpty(GiftCard.Additional_Benefits)?GiftCard.Additional_Benefits:Membership.Additional_Benefits;
                Membership.Status               = !string.IsNullOrEmpty(GiftCard.Status)?GiftCard.Status:Membership.Status;
