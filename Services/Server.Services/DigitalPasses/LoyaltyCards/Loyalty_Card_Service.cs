...
namespace Server.Services
{
    public class Loyalty_Card_Service : Base_Service<LoyaltyCard>, ILoyalty_Card_Service
    {
        ...
        private readonly ILoyalty_Card_Repo       _iRepo;
        ...
        /// <returns></returns>
        public async Task<ResponseModel<string>> GenerateCard(Apple_Passes_Loyalty_Card_Model model)
        {
            try
            {
                ...
                //Getting Pass
                LoyaltyCard Membership          = new();
                Membership.Type                 = Pass_Type_GModel.LoyaltyCard; 
                ...
                Membership.Program_Name         = model.Program_Name;
                Membership.Points_Balance       = model.Points_Balance;
        ...
        public async Task<ResponseModel<string>> UpdateGiftCard(Apple_Passes_Loyalty_Card_Model GiftCard)
        {
           try
            {
                ResponseModel<string> giftResponse = new()
                ...
                LoyaltyCard Membership         = await _iRepo.FindOne(x=>x.Id==GiftCard.Id);
                ...
                Membership.Program_Name         = !string.IsNullOrEmpty(GiftCard.Program_Name)? GiftCard.Program_Name:Membership.Program_Name;
                Membership.Points_Balance       = GiftCard.Points_Balance;
